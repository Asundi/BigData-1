...
val numList= List.range(1,20);System.out.println("""numList  : List[Int] = """ + $show(numList ));$skip(41); 
val div3Num= numList.filter( _ % 3 == 0);System.out.println("""div3Num  : List[Int] = """ + $show(div3Num ));$skip(16); 
print (div3Num)}
