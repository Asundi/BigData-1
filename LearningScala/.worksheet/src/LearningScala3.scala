object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  def toUpperString (y :String ,f: String => String): String ={
  f(y)
  };System.out.println("""toUpperString: (y: String, f: String => String)String""");$skip(58); 
  
  val value2= toUpperString("foo", y => y.toUpperCase);System.out.println("""value2  : String = """ + $show(value2 ));$skip(21); 
