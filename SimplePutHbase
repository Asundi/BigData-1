...
public class SimplePut {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try{
            ...
            put1.addColumn(PERSONAL_CF, EMPLOYED_COLUMN, Bytes.toBytes("yes"));
            put1.addColumn(PERSONAL_CF, FIELD_COLUMN, Bytes.toBytes("construction"));
            table.put(put1);
            ...
            put2.addColumn(PERSONAL_CF, FIELD_COLUMN, Bytes.toBytes("politics"));
            ...
            put3.addColumn(PERSONAL_CF, FIELD_COLUMN, Bytes.toBytes("politics"));
